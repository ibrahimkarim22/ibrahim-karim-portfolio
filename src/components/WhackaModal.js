    ...
    <Modal isOpen={isOpen} toggle={closeModal} fullscreen>
      ...
      <ModalBody className="whacka-modal-body">
        <div className="whacka-modal-info">
          ...
          GitHub plus VS Code Live Share was the most important aspect of this project. It
          is a 2D game where you have to hit as many moles as you can. Don't
          forget: you have 1 life. Don't hit the empty holes. Don't miss the extra points mole. Do Not
          click on the Nuke!
        </div>
      ...
      <ModalFooter className="whacka-modal-footer">
        ...
        <Button color="warning" className="whacka-play-btn" onClick={src => window.open("https://whackamolewhackamole.web.app", "_blank")}>Play Now!</Button>
        <Button color="info" className="whacka-modal-github-btn" onClick={src => window.open("https://github.com/ibrahim-karim-22/portfolioprojectgame")}>GitHub</Button>
      </ModalFooter>
    </Modal>
  );
}
