        ...
        <>
          <div className="menu-div-main">
            <div className="contact-items">
              ...
              <a href="https://github.com/ibrahim-karim-22" target="_blank" className="github" style={{ textDecoration: "none" }}>
              Github
              </a>
            ...
            <div className="bio-div-main-container">
              <div className="bio-div-main">
                ...
                something that seems impossible to me at first.
              </div>
            </div>
            ...
            <div className="menu-items">
              ...
              <a href="https://drive.google.com/file/d/1Mc2SdmCu-oop6GbOgkBhhYwq8rDUKLsO/view?usp=sharing" target="_blank" style={{ textDecoration: "none" }}>
              <div className="pdfResume-title-div-container">
                <div className="pdfResume-title-div">
                Resume
                </div>
              </div>
              </a>
